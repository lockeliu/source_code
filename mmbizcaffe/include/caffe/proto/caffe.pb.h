...
class ImageDataParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.ImageDataParameter) */ {
 public:
  ...
  // optional int32 num_aug = 13 [default = 0];
  bool has_num_aug() const;
  void clear_num_aug();
  static const int kNumAugFieldNumber = 13;
  ::google::protobuf::int32 num_aug() const;
  void set_num_aug(::google::protobuf::int32 value);

  // optional int32 multi_label = 14 [default = 1];
  bool has_multi_label() const;
  void clear_multi_label();
  static const int kMultiLabelFieldNumber = 14;
  ::google::protobuf::int32 multi_label() const;
  void set_multi_label(::google::protobuf::int32 value);

  // optional int32 multi_modality = 15 [default = 1];
  bool has_multi_modality() const;
  void clear_multi_modality();
  static const int kMultiModalityFieldNumber = 15;
  ::google::protobuf::int32 multi_modality() const;
  void set_multi_modality(::google::protobuf::int32 value);

  // optional int32 preserve_space = 16 [default = 0];
  bool has_preserve_space() const;
  void clear_preserve_space();
  static const int kPreserveSpaceFieldNumber = 16;
  ::google::protobuf::int32 preserve_space() const;
  void set_preserve_space(::google::protobuf::int32 value);
 ...
 private:
  ...
  inline void set_has_num_aug();
  inline void clear_has_num_aug();
  inline void set_has_multi_label();
  inline void clear_has_multi_label();
  inline void set_has_multi_modality();
  inline void clear_has_multi_modality();
  inline void set_has_preserve_space();
  inline void clear_has_preserve_space();
  ...
  ::google::protobuf::internal::ArenaStringPtr mean_file_;
  ::google::protobuf::uint32 crop_size_;
  ::google::protobuf::int32 num_aug_;
  ::google::protobuf::internal::ArenaStringPtr root_folder_;
  ::google::protobuf::int32 multi_label_;
  ::google::protobuf::int32 multi_modality_;
  ::google::protobuf::int32 preserve_space_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();
...
// optional int32 num_aug = 13 [default = 0];
inline bool ImageDataParameter::has_num_aug() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void ImageDataParameter::set_has_num_aug() {
  _has_bits_[0] |= 0x00001000u;
}
inline void ImageDataParameter::clear_has_num_aug() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void ImageDataParameter::clear_num_aug() {
  num_aug_ = 0;
  clear_has_num_aug();
}
inline ::google::protobuf::int32 ImageDataParameter::num_aug() const {
  // @@protoc_insertion_point(field_get:caffe.ImageDataParameter.num_aug)
  return num_aug_;
}
inline void ImageDataParameter::set_num_aug(::google::protobuf::int32 value) {
  set_has_num_aug();
  num_aug_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageDataParameter.num_aug)
}

// optional int32 multi_label = 14 [default = 1];
inline bool ImageDataParameter::has_multi_label() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void ImageDataParameter::set_has_multi_label() {
  _has_bits_[0] |= 0x00002000u;
}
inline void ImageDataParameter::clear_has_multi_label() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void ImageDataParameter::clear_multi_label() {
  multi_label_ = 1;
  clear_has_multi_label();
}
inline ::google::protobuf::int32 ImageDataParameter::multi_label() const {
  // @@protoc_insertion_point(field_get:caffe.ImageDataParameter.multi_label)
  return multi_label_;
}
inline void ImageDataParameter::set_multi_label(::google::protobuf::int32 value) {
  set_has_multi_label();
  multi_label_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageDataParameter.multi_label)
}

// optional int32 multi_modality = 15 [default = 1];
inline bool ImageDataParameter::has_multi_modality() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void ImageDataParameter::set_has_multi_modality() {
  _has_bits_[0] |= 0x00004000u;
}
inline void ImageDataParameter::clear_has_multi_modality() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void ImageDataParameter::clear_multi_modality() {
  multi_modality_ = 1;
  clear_has_multi_modality();
}
inline ::google::protobuf::int32 ImageDataParameter::multi_modality() const {
  // @@protoc_insertion_point(field_get:caffe.ImageDataParameter.multi_modality)
  return multi_modality_;
}
inline void ImageDataParameter::set_multi_modality(::google::protobuf::int32 value) {
  set_has_multi_modality();
  multi_modality_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageDataParameter.multi_modality)
}

// optional int32 preserve_space = 16 [default = 0];
inline bool ImageDataParameter::has_preserve_space() const {
  return (_has_bits_[0] & 0x00008000u) != 0;
}
inline void ImageDataParameter::set_has_preserve_space() {
  _has_bits_[0] |= 0x00008000u;
}
inline void ImageDataParameter::clear_has_preserve_space() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void ImageDataParameter::clear_preserve_space() {
  preserve_space_ = 0;
  clear_has_preserve_space();
}
inline ::google::protobuf::int32 ImageDataParameter::preserve_space() const {
  // @@protoc_insertion_point(field_get:caffe.ImageDataParameter.preserve_space)
  return preserve_space_;
}
inline void ImageDataParameter::set_preserve_space(::google::protobuf::int32 value) {
  set_has_preserve_space();
  preserve_space_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImageDataParameter.preserve_space)
}
